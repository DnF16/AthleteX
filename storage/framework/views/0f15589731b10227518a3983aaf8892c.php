    ...
    <nav class="flex-1">
        <ul class="space-y-2 w-max">
            ...
            <?php if(auth()->check() && auth()->user()->role === 'admin'): ?>
                <li>
                    <a href="<?php echo e(route('admin.approvals')); ?>" class="flex items-center px-3 py-2 rounded bg-[#3b5d28] font-semibold hover:bg-[#446634] transition-colors text-white no-underline">
                        <i class="bi bi-bell-fill mr-2"></i> Athlete Approvals
                    </a>
                </li>
                
                <li>
                    <a href="<?php echo e(route('admin.tryouts.index')); ?>" class="flex items-center px-3 py-2 rounded <?php echo e(request()->routeIs('admin.tryouts.index') ? 'bg-[#446634]' : 'bg-[#3b5d28]'); ?> font-semibold hover:bg-[#446634] transition-colors text-white no-underline">
