                            ...
                            <?php if(isset($recruits) && $recruits->count() > 0): ?>
                                <?php $__currentLoopData = $recruits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recruit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-yellow-50 border-b">
                                        <td class="px-4 py-3 border-r font-bold text-gray-900 uppercase"><?php echo e($recruit->last_name); ?>, <?php echo e($recruit->first_name); ?></td>
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            ...
                                            <div class="flex justify-center gap-2">
                                                <button type="button" class="bg-gray-500 text-white hover:bg-gray-600 px-3 py-2 rounded text-xs font-bold transition flex items-center shadow-sm" data-bs-toggle="modal" data-bs-target="#viewTryoutModal<?php echo e($recruit->id); ?>">
                                                    <i class="fas fa-eye mr-1"></i> View
                                                </button>
                                                
                                                <a href="<?php echo e(route('student.athlete', ['id' => $recruit->id])); ?>" class="bg-blue-600 text-white hover:bg-blue-700 px-3 py-2 rounded text-xs font-bold transition flex items-center shadow-sm">
...
<?php if(isset($recruits) && $recruits->count() > 0): ?>
    <?php $__currentLoopData = $recruits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recruit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="viewTryoutModal<?php echo e($recruit->id); ?>" tabindex="-1" data-bs-backdrop="false" style="background-color: rgba(0, 0, 0, 0.6);">
                ...
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <div class="modal-body p-4 text-start">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                            <div>
                                <h4 class="fw-bold text-dark uppercase mb-1"><?php echo e($recruit->last_name); ?>, <?php echo e($recruit->first_name); ?></h4>
                                <p class="text-muted small mb-0"><i class="fas fa-graduation-cap me-1"></i> <?php echo e($recruit->course ?? 'Course N/A'); ?> - Year <?php echo e($recruit->year_level ?? 'N/A'); ?></p>
                            </div>
                            <span class="badge bg-warning text-dark fs-6 px-4 py-2 shadow-sm rounded-pill"><?php echo e(str_replace('_', ' ', $recruit->sport_event)); ?></span>
                        </div>

                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label class="text-muted small fw-bold text-uppercase">Specialization / Role</label>
                                <p class="fw-semibold text-dark fs-5 mb-0"><?php echo e($recruit->specialization ?? 'None specified'); ?></p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted small fw-bold text-uppercase">School Graduated From</label>
                                <p class="fw-semibold text-dark fs-5 mb-0"><?php echo e($recruit->school_graduated ?? 'Not provided'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="bg-light p-3 rounded border text-dark fst-italic">
                                "<?php echo e($recruit->purpose ?? 'No purpose statement provided.'); ?>"
                            </div>
                        </div>
