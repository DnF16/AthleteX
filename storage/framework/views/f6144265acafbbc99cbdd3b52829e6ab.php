            ...
            <tbody>
                <?php $__currentLoopData = $athletes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $athlete): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border px-4 py-2 font-semibold"><?php echo e($athlete->last_name); ?></td>
                        ...
                        <td class="border px-4 py-2"><?php echo e($athlete->sport); ?></td> <td class="border px-4 py-2 text-center">
                            <span class="px-2 py-1 rounded text-white text-xs font-bold <?php echo e($athlete->status == 'Active' ? 'bg-green-500' : 'bg-gray-500'); ?>">
                        ...
                        <td class="border px-4 py-2 text-center">
                            <span class="px-2 py-1 rounded text-white text-xs font-semibold
                                <?php echo e($athlete->approval_status == 'approved' ? 'bg-blue-500' : ($athlete->approval_status == 'pending' ? 'bg-yellow-500' : 'bg-red-500')); ?>">
                                <?php echo e(ucfirst($athlete->approval_status)); ?>

                            </span>
                        </td>
                        <td class="border px-4 py-2"><?php echo e($athlete->classification); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->sex); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->birthdate); ?></td>
                        ...
                        <td class="border px-4 py-2 text-center"><?php echo e($athlete->year_level); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->email); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->facebook); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->civil_status); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->contact_number); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->address); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->city_municipality); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->province); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->zip_code); ?></td>
                        <td class="border px-4 py-2"><?php echo e($athlete->emergency_person); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->emergency_contact); ?></td> <td class="border px-4 py-2"><?php echo e($athlete->coach_name ?? '-'); ?></td>
