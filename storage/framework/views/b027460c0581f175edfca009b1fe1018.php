                    ...
                    <form action="<?php echo e(route('admin.saveSettings')); ?>" method="POST">
                        ...
                        <div class="section-box border p-3 mb-3" style="background-color: #DCE6F1; border: 1px solid #999;">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-4"><div class="form-check form-switch"><input type="hidden" name="share_sync" value="0"><input class="form-check-input" type="checkbox" role="switch" name="share_sync" value="1" <?php echo e(\App\Models\Setting::get('share_sync') == '1' ? 'checked' : ''); ?>></div></div>
                                <div class="col-md-2 text-end"><label class="form-label-sm fw-bold">Sort Names By</label></div>
                                <div class="col-md-4"><select class="form-select form-select-sm" name="sort_names"><option value="last_first" <?php echo e(\App\Models\Setting::get('sort_names') == 'last_first' ? 'selected' : ''); ?>>Last Name, First Name</option><option value="first_last" <?php echo e(\App\Models\Setting::get('sort_names') == 'first_last' ? 'selected' : ''); ?>>First Name, Last Name</option></select></div>
                            </div>

                            <div class="row mb-2 align-items-center">
                                <div class="col-md-2 text-end"><label class="form-label-sm fw-bold">App/Shared Folder</label></div>
                                <div class="col-md-10"><div class="input-group input-group-sm"><input type="text" name="shared_folder" id="folder_display" class="form-control" value="<?php echo e(\App\Models\Setting::get('shared_folder', 'D:\Documents_File\1. Important Databases')); ?>"><button class="btn btn-success" type="button" onclick="document.getElementById('hidden_folder_input').click();"><i class="fas fa-folder-open"></i></button><input type="file" id="hidden_folder_input" style="display: none;" onchange="document.getElementById('folder_display').value = this.value;"></div></div>
                            </div>
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-4"><input type="text" name="format_percent" class="form-control form-control-sm" value="<?php echo e(\App\Models\Setting::get('format_percent', '0%')); ?>"></div>
                                <div class="col-md-2 text-end"><label class="form-label-sm fw-bold">Date Format</label></div>
                                <div class="col-md-4"><input type="text" name="format_date" class="form-control form-control-sm" value="<?php echo e(\App\Models\Setting::get('format_date', 'mm/dd/yy')); ?>"></div>
                            </div>

                            <div class="row mb-2 align-items-center">
                                <div class="col-md-2 text-end"><label class="form-label-sm fw-bold">Time Format</label></div>
                                <div class="col-md-4"><input type="text" name="format_time" class="form-control form-control-sm" value="<?php echo e(\App\Models\Setting::get('format_time', 'h:mm am/pm')); ?>"></div>
                                <div class="col-md-2 text-end"><label class="form-label-sm fw-bold">Currency Format</label></div>
                                <div class="col-md-4"><input type="text" name="format_currency" class="form-control form-control-sm" value="<?php echo e(\App\Models\Setting::get('format_currency', '$#,##0.00')); ?>"></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AthleteX\resources\views/admin/settings.blade.php ENDPATH**/ ?>