            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="section-box">
                        <h6 class="fw-bold border-bottom pb-2">Add Item</h6>
                        <form action="<?php echo e(route('admin.addTransaction')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-8">
                    <table class="table table-bordered custom-table bg-white table-striped">
                        <thead><tr><th>Item Name</th><th>Type</th><th>Category</th></tr></thead>
                        <tbody>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr><td><?php echo e($item->name); ?></td><td><?php echo e($item->type); ?></td><td><?php echo e($item->category); ?></td></tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr><td>School Fee</td><td>Income</td><td>Fees</td></tr>
                            <tr><td>Coach Salary</td><td>Expense</td><td>Salaries</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\caps\athletix\AthleteX\resources\views\admin\transactions.blade.php ENDPATH**/ ?>