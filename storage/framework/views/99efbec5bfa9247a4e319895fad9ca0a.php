...
<body>
    <div class="container">
        ...
        <p>Hello <strong><?php echo e($athlete->first_name); ?></strong>,</p>
        <p>Thank you for registering for the <strong><?php echo e(str_replace('_', ' ', $schedule->sport_event)); ?></strong> tryouts. Your application has been received!</p>
        
        <p>Here are the official details for your tryout. Please make sure to be there on time:</p>
        
        <div class="details">
            <ul>
                <li>📅 <strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($schedule->tryout_date)->format('F d, Y')); ?></li>
                <li>⏰ <strong>Time:</strong> <?php echo e(\Carbon\Carbon::parse($schedule->tryout_time)->format('h:i A')); ?></li>
                <li>📍 <strong>Venue:</strong> <?php echo e($schedule->venue); ?></li>
                <?php if($schedule->notes): ?>
                    <li>📝 <strong>Notes:</strong> <?php echo e($schedule->notes); ?></li>
                <?php endif; ?>
            </ul>
        </div>
...
</html><?php /**PATH D:\xampp\htdocs\AthleteX\resources\views/features/email_tryout.blade.php ENDPATH**/ ?>