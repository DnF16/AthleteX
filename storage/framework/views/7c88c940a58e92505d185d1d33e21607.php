                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center p-2 bg-white">
                                        <div class="border d-flex align-items-center justify-content-center mb-2 bg-light" style="height: 100px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\caps\athletix\AthleteX\resources\views\admin\general.blade.php ENDPATH**/ ?>