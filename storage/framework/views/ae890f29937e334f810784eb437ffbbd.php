    ...
    <div class="flex-1 flex flex-col h-full">
        ...
        <main class="p-6 flex-1 overflow-y-auto h-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <a href="<?php echo e(route('achievements.index')); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg transition cursor-pointer no-underline group">
                ...
                <a href="<?php echo e(route('admin.approvals')); ?>" class="block bg-white p-5 rounded-xl shadow hover:shadow-lg transition cursor-pointer no-underline group">
