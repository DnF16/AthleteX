...
<div class="container">
        ...
        <div class="form-section">
            ...
            <?php if(session('success')): ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-success">Return to Home</a>
                </div>
            <?php else: ?>
            ...
            <form action="<?php echo e(route('alumni.register.submit')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="student_id" class="form-control" placeholder="e.g. 2020-10452" value="<?php echo e(old('student_id')); ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="example@gmail.com" value="<?php echo e(old('email')); ?>" required>
                </div>
                ...
                <div class="d-grid gap-2 mt-5">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-link text-secondary text-decoration-none text-center">Cancel</a>
                </div>
    ...
    <div class="text-center text-muted mb-5 small">
        &copy; <?php echo e(date('Y')); ?> Sports Development Office System
    </div>
</div>

</body>
</html><?php /**PATH C:\xampp\htdocs\caps\athletix\AthleteX\resources\views/features/alumni_registration.blade.php ENDPATH**/ ?>