...
<script>
    ...
    window.achievementsMonthly = @json($achievementsMonthly ?? []);
    window.athleteCategories = @json(array_values($athleteCategories ?? []));
    window.scheduleEvents = @json($scheduleEvents ?? []);
</script>
