                                ...
                                @foreach ($recruits as $recruit)
                                    <tr class="hover:bg-yellow-50 border-b">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <a href="{{ route('student.athlete', ['id' => $recruit->id]) }}" class="bg-blue-600 text-white hover:bg-blue-700 px-3 py-2 rounded text-xs font-bold transition">Update to Official Athlete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
