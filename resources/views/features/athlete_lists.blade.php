        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <select name="sport" onchange="this.form.submit()" class="border border-gray-300 rounded px-2 py-2 text-sm w-full focus:outline-none focus:border-green-500 bg-white">
                ...
                <optgroup label="Ball Games">
                    ...
                    <option value="Softball" {{ request('sport') == 'Softball' ? 'selected' : '' }}>Softball</option>
                    <option value="Baseball" {{ request('sport') == 'Baseball' ? 'selected' : '' }}>Baseball</option>
                </optgroup>
                
                <optgroup label="Racket Sports">
                    <option value="Badminton_Men" {{ request('sport') == 'Badminton_Men' ? 'selected' : '' }}>Badminton (Men)</option>
                    <option value="Badminton_Women" {{ request('sport') == 'Badminton_Women' ? 'selected' : '' }}>Badminton (Women)</option>
                    <option value="Table_Tennis_Men" {{ request('sport') == 'Table_Tennis_Men' ? 'selected' : '' }}>Table Tennis (Men)</option>
                    <option value="Table_Tennis_Women" {{ request('sport') == 'Table_Tennis_Women' ? 'selected' : '' }}>Table Tennis (Women)</option>
                    <option value="Tennis_Men" {{ request('sport') == 'Tennis_Men' ? 'selected' : '' }}>Tennis (Men)</option>
                    <option value="Tennis_Women" {{ request('sport') == 'Tennis_Women' ? 'selected' : '' }}>Tennis (Women)</option>
                </optgroup>
                
                <optgroup label="Combat Sports & Others">
                    <option value="Taekwondo_Men" {{ request('sport') == 'Taekwondo_Men' ? 'selected' : '' }}>Taekwondo (Men)</option>
                    <option value="Taekwondo_Women" {{ request('sport') == 'Taekwondo_Women' ? 'selected' : '' }}>Taekwondo (Women)</option>
                    <option value="Arnis_Men" {{ request('sport') == 'Arnis_Men' ? 'selected' : '' }}>Arnis (Men)</option>
                    <option value="Arnis_Women" {{ request('sport') == 'Arnis_Women' ? 'selected' : '' }}>Arnis (Women)</option>
                    <option value="Boxing" {{ request('sport') == 'Boxing' ? 'selected' : '' }}>Boxing</option>
                    <option value="Sepak_Takraw" {{ request('sport') == 'Sepak_Takraw' ? 'selected' : '' }}>Sepak Takraw</option>
                    <option value="Chess" {{ request('sport') == 'Chess' ? 'selected' : '' }}>Chess</option>
                    <option value="Swimming" {{ request('sport') == 'Swimming' ? 'selected' : '' }}>Swimming</option>
                    <option value="Athletics" {{ request('sport') == 'Athletics' ? 'selected' : '' }}>Athletics</option>
                </optgroup>
            </select>
                ...
                @forelse ($athletes as $index => $athlete)
                    <tr class="hover:bg-gray-50 border-b border-gray-100">
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            <span class="{{ $badgeColor }} text-white px-3 py-1 rounded-full text-xs shadow-sm whitespace-nowrap">
