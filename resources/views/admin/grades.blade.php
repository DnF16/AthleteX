                            ...
                            <div class="col-md-4">
                                <div class="border border-secondary">
                                    ...
                                    <table class="table table-bordered border-secondary mb-0 text-center bg-white table-sm">
                                        ...
                                        <tbody>
                                            {{-- Loop existing grades from DB ($grades passed from controller) --}}
                                            @php $grades = \App\Models\GradeScale::all(); @endphp
                                            @for($i = 0; $i < 8; $i++)
                                            <tr>
                            ...
                            <div class="col-md-5">
                                <div class="border border-secondary">
                                    ...
                                    <table class="table table-bordered border-secondary mb-0 text-center bg-white table-sm">
                                        ...
                                        <tbody>
                                            @php $scholarships = \App\Models\ScholarshipCriteria::all(); @endphp
                                            @for($i = 0; $i < 8; $i++)
                                            <tr>
